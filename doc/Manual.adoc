...
As measured in "Simple Effective and Robust Weight Sensor for Measuring Moisture Content in Food Drying Process": using a Low Pass Filter (moving average) is equivalent to a Kalman filter for HX711.
